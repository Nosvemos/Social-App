      ...
      >
        <div className="min-h-screen">
          <div className="grid grid-cols-12 container mx-auto">
            ...
            <div className="col-span-2 sm:col-span-1 md:col-span-1 lg:col-span-1 xl:col-span-2 h-screen sticky top-0 overflow-y-auto scrollbar-light dark:scrollbar-dark">
              <Menu />
            </div>
