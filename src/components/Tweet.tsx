...
import { ChartNoAxesColumn, Expand, Heart, Loader2, Repeat, Trash } from 'lucide-react'
            ...
            <div className='flex flex-row gap-2 text-sm md:text-base'>
              ...
              <div className='ml-auto'>
                {dbUserId === post.author.id && (
                  <Button className='rounded-full text-neutral-500' size='deleteIcon' variant='iconButton' onClick={handleDeletePost}>
                    {isDeleting ? (
                ...
                <Link href={`/${post.author.username}/status/${post.id}`}>
                  <Button className='rounded-full text-neutral-500' size='deleteIcon' variant='iconButton'>
                    <Expand/>
                  </Button>
                </Link>
              </div>
